...
class AsyntaiController(http.Controller):
    ...
    @http.route('/asyntai/api/save', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/asyntai/api/reset', type='json', auth='user', methods=['POST'], csrf=False)
    ...
    @http.route('/asyntai/api/status', type='json', auth='user', methods=['POST'], csrf=False)
